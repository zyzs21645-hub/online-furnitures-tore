...
$db   = getenv('DB_NAME') ?: 'furniture_store';
...
try {
    ...
    echo "furniture_items table created\n";
    ...
    $pdo->exec("
        ...
        AND NOT EXISTS (
            SELECT 1 FROM furniture_items WHERE item_name = 'Modern Sofa'
        );
    ");

    echo "sample furniture inserted\n";
